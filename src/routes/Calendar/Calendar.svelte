<script lang="ts">
    ...
    // ну и не забывай это компонент библиотечный ты делаешь он работает
    // в отрыве от бизнес значения чтобы удобно использовать в разных местах
    // тут например могут быть разные юзеры и они буду в продукте ключом для определения
    // цвета например
    ...
    // тож проперти participant_id в продукте а тут именно как appointments с нужным форматом
